#
# Manifiesto del módulo 'PSGet_UIfied'
#
# Generado por Code
#
...
GUID = '1f7a7da2-10ba-4406-be71-e102a3529039'
...
FunctionsToExport = 'Get-UIDatePicker', 'Get-UIModal', 'Get-UITimer', 'Get-UIButton', 'Get-UIHost', 
               ...
               'Get-UIPassword', 'Add-UIChild', 'Remove-UIChild', 'Get-UIFileUpload'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'PowerShell','GUI','UI','TUI','WPF','Web','Console'

        # A URL to the license for this module.
        LicenseUri = 'https://raw.githubusercontent.com/code-numericoverflow/UIfied/master/UIfied/LICENSE.txt'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/code-numericoverflow/UIfied'

        # A URL to an icon representing this module.
        IconUri = 'https://raw.githubusercontent.com/code-numericoverflow/UIfied/master/sign-form.png'
